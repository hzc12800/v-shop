    ...
    <el-card>
      ...
      <tree-table class="treeTable" :data="catelist" :columns="columns" :selection-type="false" :expand-type="false" show-index index-text="#" border>
        ...
        <template v-slot:opt="scope">
          <el-button type="primary" icon="el-icon-edit" size="mini" v-if="scope.row.cat_level === 0">编辑</el-button>
    ...
    <el-dialog title="添加分类" :visible.sync="addCateDialogVisible" width="50%" @close="addCateDialogClosed">
      ...
      <el-form :model="addCateForm" :rules="addCateFormRules" ref="addCateFormRef" label-width="100px">
        ...
        <el-form-item label="父级分类：">
          <!-- options用来指定数据源 -->
          <!-- <el-cascader v-model="value" :options="parentCateList" :props="cascaderProps" @change="handleChange"></el-cascader> -->
          <el-cascader v-model="selectedKeys" :options="parentCateList" :props="{ expandTrigger: 'hover', value: 'cat_id', label: 'cat_name', children: 'children', checkStrictly: true }" @change="parentCateChanged" clearable></el-cascader>
        </el-form-item>
      </el-form>
